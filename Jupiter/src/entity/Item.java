...
public class Item {
	// return to front end to show
	// but the parsing is json
	// so toJSONObject() is for transfer to json
	...
	// thus the customer can not use it to change anything
	// instead the customer can only use build pattern to construct
	...
	public JSONObject toJSONObject() {
		// by storing in the object as key value pair
